...
if __name__ == "__main__":
    ...
    cfg.checkpoint_path = "/scratch/tshu2/yyin34/projects/3d_belief/embodied_belief/DFM/outputs/weights/semantic/semantic_from_plain_lock_others_high_lr/model-66.pt"
